...
class CommonPlatform ():
    PackagesSupported = ("sapphirePkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('sapphire', 'gcc_aarch64_linux', 'edk2-build')
...
class SettingsManager (UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager, ParseSettingsManager):
    ...
    def GetPlatformDscAndConfig (self) -> tuple:
        return ("sapphirePkg/sapphire.dsc", {})
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "sapphire", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "sapphirePkg/sapphire.dsc", "Platform Hardcoded")
